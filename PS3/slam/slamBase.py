...
class SlamBase(ABC):
    def __init__(self, slam_type, data_association, update_type, Q):
        """
        :param slam_type: Which SLAM algorithm to run: ONLINE SLAM (ekf) or smoothing the full trajectory using Factor graphs (graphSlam).
        ...
        assert slam_type in {'ekf', 'graphSlam'}
